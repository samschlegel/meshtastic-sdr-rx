...
# Title: LoRa RX - SDRplay RSPdx R2
...
class lora_rx_sdrplay(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LoRa RX - SDRplay RSPdx R2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LoRa RX - SDRplay RSPdx R2")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "lora_rx_sdrplay")
        ...
        self.cr = cr = 1
        self.center_freq = center_freq = 913.125e6
        self.bw = bw = 250000
        ...
        self.sdrplay3_rspdxr2_0.set_gain(-(40), 'IF', False)
        self.sdrplay3_rspdxr2_0.set_gain(10, 'LNAstate', False)
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.lora_sdr_header_decoder_0 = lora_sdr.header_decoder(impl_head, cr, pay_len, has_crc, False, False)
        ...
        self.lora_sdr_frame_sync_0 = lora_sdr.frame_sync(int(center_freq), bw, sf, impl_head, [0,0], (int(samp_rate/bw)),17)
...
def main(top_block_cls=lora_rx_sdrplay, options=None):
